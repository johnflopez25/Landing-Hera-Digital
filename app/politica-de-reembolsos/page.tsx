      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="space-y-8 text-hera-white/70 leading-relaxed">
          ...
          <p className="mt-12 pt-8 border-t border-white/10">
            Para solicitar revisión de un caso, escribe a <a href="mailto:soporte@heradigital.co" className="text-hera-red hover:underline">soporte@heradigital.co</a> indicando tu nombre, correo de compra, producto adquirido y motivo de la solicitud.
          </p>
        </div>
      </div>
    </main>
