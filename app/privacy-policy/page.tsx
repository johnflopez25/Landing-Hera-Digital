    ...
    <main className="min-h-screen bg-[#0a0a0a] text-hera-white py-24 px-6 md:px-12 font-sans relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="space-y-8 text-hera-white/70 leading-relaxed">
          ...
          <p>
            Los usuarios pueden solicitar acceso, corrección o eliminación de sus datos escribiendo a <a href="mailto:soporte@heradigital.co" className="text-hera-red hover:underline">soporte@heradigital.co</a>.
          </p>
